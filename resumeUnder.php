...
<html lang="fr">
    <head>
        ...
        <title>Qu'est-ce qu'Unde'R ?</title>
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous" />
        <link href="https://fonts.googleapis.com/css?family=Gugi" rel="stylesheet" />
        <link rel="stylesheet" href="assets/css/styleResumeUnder.css" />
    </head>
    <body>
            ...
            <div class="container typeStyle">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-deck">
                            <div class="card">
                                <img class="card-img-top" src="assets/images/iconsResume/mpd-top-view.png" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">Beatmk'R</h5>
                                    <p class="card-text">Tu es un producteur de beat hors paire ? Choisi donc ce profil et fait partager tes compositions au reste des useUnde'R </p>
                                </div>
                            </div>
                            <div class="card">
